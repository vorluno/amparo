...
```bash
bun dev &
curl -N -X POST http://localhost:3947/api/solicitudes/PA-0001/analizar
```
...
bun dev
```
Abrir `http://localhost:3947`: tabla con PA-0001 y PA-0003 (estado real de Notion). Capturas a 1280 y 400 (con `example-skills:webapp-testing` o Chrome): sin scroll horizontal en 400 salvo el de la tabla contenida.
